...
export default function EditJobPage({ params }: { params: { id: string } }) {
        ...
        const fetchJob = async () => {
            try {
                ...
                setFormData({
                    ...
                    skills: Array.isArray(data.skills) ? Array.from(new Set(data.skills as string[])) : [],
                    salaryMin: min,
                    salaryMax: max,
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (hasMin && hasMax) {
                ...
                finalSalary = formData.salaryMin;
            } else if (hasMax) {
                finalSalary = formData.salaryMax;
            }
    ...
    return (
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
            <Link href={`${base}/jobs`} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '24px', color: '#6b7280', textDecoration: 'none', fontWeight: '500' }}>
                ...
                <form onSubmit={handleSave} style={{ padding: '32px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px' }}>
                        <div style={{ flex: '1 1 300px' }}>
                            <label htmlFor="title" style={{ display: 'block', marginBottom: '8px', fontSize: '14px', fontWeight: '600', color: '#374151' }}>Job Title</label>
                        ...
                        <div style={{ flex: '1 1 300px' }}>
                            <label htmlFor="location" style={{ display: 'block', marginBottom: '8px', fontSize: '14px', fontWeight: '600', color: '#374151' }}>Location</label>
                            <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px' }}>
                        <div style={{ flex: '1 1 300px' }}>
                            <label htmlFor="employmentType" style={{ display: 'block', marginBottom: '8px', fontSize: '14px', fontWeight: '600', color: '#374151' }}>Employment Type</label>
                            <div style={{ position: 'relative' }}>
                        ...
                        <div style={{ flex: '1 1 300px' }}>
                            <label htmlFor="category" style={{ display: 'block', marginBottom: '8px', fontSize: '14px', fontWeight: '600', color: '#374151' }}>Category</label>
                            <div style={{ position: 'relative' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '12px' }}>
                            {formData.skills && formData.skills.map((skill: string, index: number) => (
                                <span key={`${skill}-${index}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 14px', borderRadius: '999px', fontSize: '14px', fontWeight: '500', backgroundColor: '#eff6ff', color: '#2563eb', border: '1px solid #dbeafe' }}>
                                    {skill}
                                    <button
                                        type="button"

    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
            ...
            {isDeleteModalOpen && (
                ...
                >
                    <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '32px', cursor: 'default' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
                            ...
                            <div>
                                <h3 id="delete-job-title" style={{ margin: '0 0 4px', fontSize: '18px', fontWeight: '700', color: '#111827' }}>Delete Job Post?</h3>

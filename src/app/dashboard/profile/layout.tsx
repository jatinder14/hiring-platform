...
export default async function CandidateProfileLayout({
    ...
    // 🔒 SECURITY: Companies should NOT access candidate profile (they have their own settings)
    if (role === 'CLIENT') {
        console.log(`[Security] Company ${user.id} attempted to access candidate profile.`);

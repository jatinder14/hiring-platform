...
export default function LocationSelector({
    ...
    // Unique IDs for datalist elements to avoid collisions when multiple instances render
    const instanceId = useId();
    const countryListId = `country-list-${instanceId}`;
    const stateListId = `state-list-${instanceId}`;
    const cityListId = `city-list-${instanceId}`;
